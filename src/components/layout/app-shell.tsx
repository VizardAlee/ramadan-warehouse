...
const navigation = [
  ...
  { href: "/finance", label: "Accounting", icon: Scale, permissions: ["finance.journal.read", "accounting.close.read", "banking.read"] },
  { href: "/accounting", label: "Month close", icon: Scale, permissions: ["accounting.close.read"] },
  { href: "/tax", label: "Tax Centre", icon: Calculator, permissions: ["finance.journal.read"] },
  ...
  { href: "/daily-reconciliation", label: "Daily checks", icon: ClipboardCheck, permissions: ["inventory.count", "inventory.reconcile", "sales.shift.manage", "banking.read"] },
